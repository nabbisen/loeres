...
guidance, an exact projection in the `Converged` claim) are in this `0.21.3`
tree, not yet released. The current numerical breadth is one
...
2026-09-12 and carries RFCs 001-026. Repository release `0.21.1` shipped 2026-09-24 and carries RFCs 001-029. Repository release `0.21.2` shipped 2026-09-24 and carries RFCs 001-030. This tree is `0.21.3` and is not itself a release until it is tagged and distributed. Currency lives in the apex trio's RFC 024
