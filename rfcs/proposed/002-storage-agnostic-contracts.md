...
This RFC touches only `loeres-core`. It depends on [RFC 001](001-stratified-scalar.md) for scalar bounds and [RFC 003](003-allocation-free-errors.md) for error types.
